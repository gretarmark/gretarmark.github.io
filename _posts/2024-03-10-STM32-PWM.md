...
Some motors use HAL sensor to measure the motors rotational direction but the motors used in this post do not include HAL sensors. Instead the ESC measures the back EMF from the BLDC to know its rotational direction.
