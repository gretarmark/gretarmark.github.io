...
![Fig 2]({{ site.baseurl }}/images/PWM/BLDC_fig1.png "zero order"){:width=20%}  
**Figure 2: Brushless direct current motor.**

![Fig 3]({{ site.baseurl }}/images/PWM/ESC.png "zero order"){:width=20%}  
**Figure 3: Electronic speed controller.**
